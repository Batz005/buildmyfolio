...
const contacts = [
  {
    icon: <FaEnvelope />,
    label: 'Email',
    href: LINKS.external.email, // <-- Replace with your real email
  },
  {
    icon: <FaLinkedin />,
    label: 'LinkedIn',
    href: LINKS.external.linkedin, // <-- Replace with your LinkedIn
  },
  {
    icon: <FaGithub />,
    label: 'GitHub',
    href: LINKS.external.github, // <-- Replace with your GitHub
  },
  {
    icon: <FaFileAlt />,
    label: 'Resume',
    href: LINKS.external.resume, // <-- Replace with your resume path
  },
];
